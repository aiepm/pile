...
from pile.models.mobilenet_v4 import MobilenetV4ConvLarge, MobilenetV4
...
def main():
  ...
  optimizer = optim.SGD(model.parameters(), lr=0.08, nesterov=True, momentum=0.9, weight_decay=1e-4)
  ...
  for epoch in range(NUM_EPOCHS):
    ...
    for images, labels in train_loader:
      ...
      with torch.amp.autocast(DEVICE_NAME, dtype=torch.float16):
        # Forward pass
